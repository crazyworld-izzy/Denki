...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/crazyworld-izzy/Denki",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/denkimusic")
